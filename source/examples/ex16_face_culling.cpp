...
class DepthTestingAndFaceCullingApplication : public our::Application
{
    ...
    void onInitialize() override
    {
        ...
        triangle.setVertexData<our::ColoredVertex>(0, {{{-0.5, -0.5, 0}, {255, 0, 0, 255}}, {{0.5, -0.5, 0}, {0, 255, 0, 255}}, {{0.0, 0.5, 0}, {0, 0, 255, 255}}}, GL_STATIC_DRAW);
        triangle.setElementData<GLuint>({0, 1, 2}, GL_STATIC_DRAW);
    ...
    void onDraw(double deltaTime) override
    {
        ...
        if (enable_face_culling)
            ...
            glDisable(GL_CULL_FACE); // This line enables face culling.
